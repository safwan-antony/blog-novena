...
urlpatterns = [
    ...
    path('edit-profile-patient/<str:pk>/',editProfilePatient,name='account_edit_profile-patient'),
    path('edit-profile-doctor/<str:pk>/',editProfileDoctor,name='account_edit_profile-doctor'),
